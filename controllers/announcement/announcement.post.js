...
export const createAnnouncement = async (req, res) => {
    ...
    try {
        await announceService.createAnnouncement({ title, content, notifyResidents: notifyResidentsBool, notifyOfficials: notifyOfficialsBool }, parseInt(userId), barangayId)
